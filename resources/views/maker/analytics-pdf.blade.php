...
<body>
    ...
    <div class="section">
        <h2 class="section-title">Waste Conversion Metrics</h2>
        <div class="section-description">
            This section tracks your efficiency in converting waste items into usable materials. 
            Higher conversion rates indicate effective material processing and minimal waste 
            in your upcycling operations.
        </div>
        
        @if($stats['waste_items_purchased'] > 0 || $stats['waste_items_converted'] > 0)
            <div class="description">
                Progress in converting waste items into usable materials. Monitoring these metrics 
                helps optimize your material acquisition and processing strategies for maximum 
                efficiency and minimal waste.
            </div>

            <div class="stats-grid">
                <div class="stat-card">
                    <div class="stat-value">{{ $stats['waste_items_purchased'] }}</div>
                    <div class="stat-label">Waste Items</div>
                    <div class="stat-subtitle">
                        Total waste items acquired
                    </div>
                </div>
                <div class="stat-card">
                    <div class="stat-value">{{ $stats['waste_items_converted'] }}</div>
                    <div class="stat-label">Materials Created</div>
                    <div class="stat-subtitle">
                ...
                <div class="stat-card">
                    <div class="stat-value">{{ $stats['waste_items_purchased'] > 0 ? round(($stats['waste_items_converted'] / $stats['waste_items_purchased']) * 100) : 0 }}%</div>
                ...
                <div class="stat-card">
                    <div class="stat-value">{{ number_format($stats['material_stock'], 1) }}</div>
            ...
            <div class="description" style="font-size: 10px; color: #718096; margin-top: 10px;">
                <strong>Note:</strong> A high conversion rate indicates efficient processing of waste items into 
                usable materials. If your conversion rate is lower than expected, consider reviewing your 
                material selection criteria or processing methods to identify improvement opportunities.
            </div>
        @else
            <div class="empty-state">
                <div class="empty-icon">♻️</div>
                <div style="font-weight: bold; margin-bottom: 8px;">No Waste Conversion Data</div>
                <div class="description">
                    Start by purchasing waste items and converting them to materials to track your conversion efficiency.
                    The conversion process transforms waste into valuable resources, creating both environmental 
