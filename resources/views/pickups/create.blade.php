...
<div class="container mx-auto px-4 py-8 max-w-2xl">
    ...
    <form method="POST" action="{{ route('pickups.store') }}" class="space-y-5">
        ...
        <div>
            ...
            <input name="pickup_address" value="{{ old('pickup_address') }}" class="w-full border rounded p-2">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="datetime-local" name="scheduled_pickup_window_start" value="{{ old('scheduled_pickup_window_start') }}" class="w-full border rounded p-2">
            ...
            <div>
                ...
                <input type="datetime-local" name="scheduled_pickup_window_end" value="{{ old('scheduled_pickup_window_end') }}" class="w-full border rounded p-2">
